...
class BackupPlugin implements Plugin
{
    ...
    {
        return $this->resource ?? config('backup-server-ui.resources.backup.resource');
    }
    ...
    {
        return $this->evaluate($this->label) ?? config('backup-server-ui.resources.backup.label');
    }
    ...
    {
        return $this->evaluate($this->pluralLabel) ?? config('backup-server-ui.resources.backup.plural_label');
    }
    ...
    {
        return $this->navigationGroup ?? config('backup-server-ui.resources.backup.navigation_group');
    }
    ...
    {
        return $this->navigationIcon ?? config('backup-server-ui.resources.backup.navigation_icon');
    }
    ...
    {
        return $this->navigationSort ?? config('backup-server-ui.resources.backup.navigation_sort');
    }
    ...
    {
        return $this->navigationCountBadge ?? config('backup-server-ui.resources.backup.navigation_count_badge');
    }
    ...
    {
        return $this->navigation ?? config('backup-server-ui.resources.backup.enabled');
    }
