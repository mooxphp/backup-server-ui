...
class DestinationPlugin implements Plugin
{
    ...
    {
        return $this->resource ?? config('backup-server-ui.resources.destination.resource');
    }
    ...
    {
        return $this->evaluate($this->label) ?? config('backup-server-ui.resources.destination.label');
    }
    ...
    {
        return $this->evaluate($this->pluralLabel) ?? config('backup-server-ui.resources.destination.plural_label');
    }
    ...
    {
        return $this->navigationGroup ?? config('backup-server-ui.resources.destination.navigation_group');
    }
    ...
    {
        return $this->navigationIcon ?? config('backup-server-ui.resources.destination.navigation_icon');
    }
    ...
    {
        return $this->navigationSort ?? config('backup-server-ui.resources.destination.navigation_sort');
    }
    ...
    {
        return $this->navigationCountBadge ?? config('backup-server-ui.resources.destination.navigation_count_badge');
    }
    ...
    {
        return $this->navigation ?? config('backup-server-ui.resources.destination.enabled');
    }
    ...
    {
        return __('backup-server-ui::translations.breadcrumb');
    }
}
