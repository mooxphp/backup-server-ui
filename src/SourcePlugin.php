...
class SourcePlugin implements Plugin
{
    ...
    {
        return $this->resource ?? config('backup-server-ui.resources.source.resource');
    }
    ...
    {
        return $this->evaluate($this->label) ?? config('backup-server-ui.resources.source.label');
    }
    ...
    {
        return $this->evaluate($this->pluralLabel) ?? config('backup-server-ui.resources.source.plural_label');
    }
    ...
    {
        return $this->navigationGroup ?? config('backup-server-ui.resources.source.navigation_group');
    }
    ...
    {
        return $this->navigationIcon ?? config('backup-server-ui.resources.source.navigation_icon');
    }
    ...
    {
        return $this->navigationSort ?? config('backup-server-ui.resources.source.navigation_sort');
    }
    ...
    {
        return $this->navigationCountBadge ?? config('backup-server-ui.resources.source.navigation_count_badge');
    }
    ...
    {
        return $this->navigation ?? config('backup-server-ui.resources.source.enabled');
    }
